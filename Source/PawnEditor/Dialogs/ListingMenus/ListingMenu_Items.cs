...
public class ListingMenu_Items : ListingMenu<ThingDef>
{
    ...
    public ListingMenu_Items(ItemType itemType, Pawn pawn, TreeNode_ThingCategory treeNodeThingCategory = null) : base(t => pawnAction(t, pawn), GetMenuTitle(itemType), pawn)
    {
        TreeNodeThingCategory = treeNodeThingCategory ?? ThingCategoryNodeDatabase.RootNode;
        type = itemType;
    ...
    {
        string typeLabel = "PawnEditor.ItemType." + itemType;
