...
public static class MaybeMathF
{
    ...
    public static float? MaybeClamp(this float? self, float min, float max)
    {
        return self.HasValue ? MathF.Min(MathF.Max(self.Value, min), max) : null;
    }

    // ── float? coalescing ─────────────────────────────────────────────────

    /// <summary>Returns <paramref name="self" /> if non-null, else <paramref name="other" /> (Option::or).</summary>
    public static float? Or(this float? self, float? other)
    {
        return self ?? other;
    }
...
public static class MaybeMathAS
{
    ...
    {
        return self.IsDefinite ? AvailableSpace.Definite(MathF.Max(self.Unwrap(), rhs)) : self;
    }

    public static AvailableSpace MaybeAdd(this AvailableSpace self, float rhs)
    {
        return self.IsDefinite ? AvailableSpace.Definite(self.Unwrap() + rhs) : self;
    }
    ...
    {
        return self.IsDefinite ? AvailableSpace.Definite(MathF.Min(MathF.Max(self.Unwrap(), min), max)) : self;
    }
...
public static class MaybeMathSize
{
    ...
    {
        return new Size<float?>(self.Width ?? other.Width, self.Height ?? other.Height);
    }
    ...
    {
        return new Size<float>(MathF.Max(self.Width, rhs.Width), MathF.Max(self.Height, rhs.Height));
    }
}