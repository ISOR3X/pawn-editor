...
public static class ResolveExt
{
    ...
    public static float? MaybeResolve(this LengthPercentage self, float? context)
    {
        ...
        // PERCENT_TAG
        return context.HasValue ? context.Value * self.Value : null;
    }
    ...
    {
        return self.MaybeResolve(context) ?? 0f;
    }
    ...
    {
        return new Size<float?>(self.Width.MaybeResolve(context.Width), self.Height.MaybeResolve(context.Height));
    }
    ...
    {
        return new Size<float>(self.Width.ResolveOrZero(context.Width), self.Height.ResolveOrZero(context.Height));
    }
