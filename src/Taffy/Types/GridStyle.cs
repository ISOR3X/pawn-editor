...
public readonly struct MinTrackSizingFunction : IEquatable<MinTrackSizingFunction>
{
    ...
    // ── Factories ─────────────────────────────────────────────────────────
    public static MinTrackSizingFunction Length(float px)
    {
        return new MinTrackSizingFunction(CompactLength.Length(px));
    }

    public static MinTrackSizingFunction Percent(float pct)
    {
        return new MinTrackSizingFunction(CompactLength.Percent(pct));
    }
    ...
    {
        return new MinTrackSizingFunction(lp.Inner);
    }
    ...
    {
        return _cl.IsIntrinsic();
    }

    public bool IsMinOrMaxContent()
    {
        return _cl.IsMinOrMaxContent();
    }

    public bool UsesPercentage()
    {
        return _cl.UsesPercentage();
    }
    ...
    public bool Equals(MinTrackSizingFunction other)
    {
        return _cl == other._cl;
    }

    public override bool Equals(object? obj)
    {
        return obj is MinTrackSizingFunction o && Equals(o);
    }

    public override int GetHashCode()
    {
        return _cl.GetHashCode();
    }
}
...
public readonly struct MaxTrackSizingFunction : IEquatable<MaxTrackSizingFunction>
{
    ...
    // ── Factories ─────────────────────────────────────────────────────────
    public static MaxTrackSizingFunction Length(float px)
    {
        return new MaxTrackSizingFunction(CompactLength.Length(px));
    }

    public static MaxTrackSizingFunction Percent(float pct)
    {
        return new MaxTrackSizingFunction(CompactLength.Percent(pct));
    }
    ...
    {
        return new MaxTrackSizingFunction(CompactLength.FitContentPx(px));
    }

    public static MaxTrackSizingFunction FitContentPercent(float p)
    {
        return new MaxTrackSizingFunction(CompactLength.FitContentPercent(p));
    }

    public static MaxTrackSizingFunction Fr(float fr)
    {
        return new MaxTrackSizingFunction(CompactLength.Fr(fr));
    }
    ...
    {
        return new MaxTrackSizingFunction(lp.Inner);
    }
    ...
    {
        return _cl.IsFitContent();
    }

    public bool IsMaxContentAlike()
    {
        return _cl.IsMaxContentAlike();
    }
    ...
    public bool Equals(MaxTrackSizingFunction other)
    {
        return _cl == other._cl;
    }
    ...
    public override bool Equals(object? obj)
    {
        return obj is MaxTrackSizingFunction o && Equals(o);
    }
...
public readonly struct TrackSizingFunction
{
    ...
    {
        return new TrackSizingFunction(MinTrackSizingFunction.MIN_CONTENT, MaxTrackSizingFunction.MIN_CONTENT);
    }

    public static TrackSizingFunction MaxContent()
    {
        return new TrackSizingFunction(MinTrackSizingFunction.MAX_CONTENT, MaxTrackSizingFunction.MAX_CONTENT);
    }

    public static TrackSizingFunction Px(float px)
    {
        return new TrackSizingFunction(MinTrackSizingFunction.Length(px), MaxTrackSizingFunction.Length(px));
    }

    public static TrackSizingFunction Percent(float pct)
    {
        return new TrackSizingFunction(MinTrackSizingFunction.Percent(pct), MaxTrackSizingFunction.Percent(pct));
    }

    public static TrackSizingFunction Fr(float fr)
    {
        return new TrackSizingFunction(MinTrackSizingFunction.AUTO, MaxTrackSizingFunction.Fr(fr));
    }

    public static TrackSizingFunction FitContentPx(float px)
    {
        return new TrackSizingFunction(MinTrackSizingFunction.AUTO, MaxTrackSizingFunction.FitContentPx(px));
    }
...
public readonly struct GridLine : IEquatable<GridLine>
{
    ...
    public override bool Equals(object? obj)
    {
        return obj is GridLine o && Equals(o);
    }
    ...
    : IEquatable<OriginZeroLine>, IComparable<OriginZeroLine>
{
    ...
    {
        return new OriginZeroLine((short)(a.Value + b.Value));
    }
    ...
    public static OriginZeroLine operator +(OriginZeroLine a, ushort b)
    {
        return new OriginZeroLine((short)(a.Value + b));
    }
    ...
    {
        return TryIntoTrackVecIndex(counts)
    ...
    {
        return Value > explicitTrackCount ? (ushort)(Value - explicitTrackCount) : (ushort)0;
    }

    public int CompareTo(OriginZeroLine other)
    {
        return Value.CompareTo(other.Value);
    }

    public bool Equals(OriginZeroLine other)
    {
        return Value == other.Value;
    }
    ...
    public override bool Equals(object? obj)
    {
        return obj is OriginZeroLine o && Equals(o);
    }
    ...
    public static bool operator <(OriginZeroLine a, OriginZeroLine b)
    {
...
public struct TrackCounts : IEquatable<TrackCounts>
{
    ...
    {
        return new OriginZeroLine((short)(Explicit + PositiveImplicit));
    }

    // ── CellOccupancyMatrix track-index ↔ OriginZero conversions ──────────

    public int OzLineToNextTrack(OriginZeroLine line)
    {
        return line.Value + NegativeImplicit;
    }

    public (int start, int end) OzLineRangeToTrackRange(Line<OriginZeroLine> r)
    {
        return (OzLineToNextTrack(r.Start), OzLineToNextTrack(r.End));
    }

    public OriginZeroLine TrackToPrevOzLine(int trackIndex)
    {
        return new OriginZeroLine((short)(trackIndex - NegativeImplicit));
    }

    public bool Equals(TrackCounts other)
    {
        return NegativeImplicit == other.NegativeImplicit &&
    ...
    public override bool Equals(object? obj)
    {
        return obj is TrackCounts o && Equals(o);
    }

    public override int GetHashCode()
    {
        return HashCode.Combine(NegativeImplicit, Explicit, PositiveImplicit);
    }

    public override string ToString()
    {
        return $"TrackCounts(-{NegativeImplicit} explicit={Explicit} +{PositiveImplicit})";
    }
}
...
public readonly struct GridPlacement : IEquatable<GridPlacement>
{
    ...
    // ── Factories ─────────────────────────────────────────────────────────
    public static readonly GridPlacement Auto = new(Kind.Auto);

    public static GridPlacement Line(short lineIndex)
    {
        return new GridPlacement(Kind.Line, lineIndex);
    }

    public static GridPlacement Line(int lineIndex)
    {
        return new GridPlacement(Kind.Line, (short)lineIndex);
    }

    public static GridPlacement Span(ushort span)
    {
        return new GridPlacement(Kind.Span, (short)span);
    }
    ...
    public GridLine AsLine()
    {
        return new GridLine(_value);
    }

    public ushort AsSpan()
    {
    ...
    public override bool Equals(object? obj)
    {
        return obj is GridPlacement o && Equals(o);
    }

    public override int GetHashCode()
    {
        return HashCode.Combine((byte)_kind, _value);
    }
...
public readonly struct OriginZeroGridPlacement : IEquatable<OriginZeroGridPlacement>
{
    ...
    public static readonly OriginZeroGridPlacement Auto = new(Kind.Auto);

    public static OriginZeroGridPlacement Line(OriginZeroLine line)
    {
        return new OriginZeroGridPlacement(Kind.Line, line.Value);
    }

    public static OriginZeroGridPlacement Span(ushort span)
    {
        return new OriginZeroGridPlacement(Kind.Span, (short)span);
    }
    ...
    public OriginZeroLine AsLine()
    {
        return new OriginZeroLine(_value);
    }
    ...
    public bool Equals(OriginZeroGridPlacement other)
    {
        return _kind == other._kind && _value == other._value;
    }
    ...
    public override bool Equals(object? obj)
    {
        return obj is OriginZeroGridPlacement o && Equals(o);
    }
...
{
    public static bool IsRow(this GridAutoFlow f)
    {
        return f == GridAutoFlow.Row || f == GridAutoFlow.RowDense;
    }

    public static bool IsDense(this GridAutoFlow f)
    {
    ...
    {
        return f.IsRow() ? AbsoluteAxis.Horizontal : AbsoluteAxis.Vertical;
    }

    public static AbsoluteAxis SecondaryAxis(this GridAutoFlow f)
    {
        return f.IsRow() ? AbsoluteAxis.Vertical : AbsoluteAxis.Horizontal;
    }
}
...
public static class LineGridPlacementExt
{
    ...
    {
        return new Line<OriginZeroGridPlacement>(
    ...
    {
        return self.Start.IsLine || self.End.IsLine;
    }
}
