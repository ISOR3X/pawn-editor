...
public static class FlexDirectionExt
{
    ...
    /// <summary>
    ///     Returns true if the direction is <see cref="FlexDirection.Column" /> or
    ///     <see cref="FlexDirection.ColumnReverse" />.
    /// </summary>
    ...
    {
        return dir.IsRow() ? AbsoluteAxis.Horizontal : AbsoluteAxis.Vertical;
    }
    ...
    {
        return dir.IsRow() ? AbsoluteAxis.Vertical : AbsoluteAxis.Horizontal;
    }
}