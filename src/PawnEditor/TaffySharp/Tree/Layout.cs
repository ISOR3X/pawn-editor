...
namespace PawnEditor.TaffySharp
{
    ...
    {
        public static readonly CollapsibleMarginSet ZERO = new CollapsibleMarginSet(0f, 0f);
        ...
        public float Resolve() => _positive + _negative;
    }
    ...
    public struct LayoutInput
    {
        ...
        public static LayoutInput Hidden => new LayoutInput
        {
    ...
    public struct LayoutOutput
    {
        ...
        public static LayoutOutput Hidden => new LayoutOutput
        {
            Size = SizeF.ZERO,
        ...
        public static LayoutOutput FromSizes(Size<float> size, Size<float> contentSize) =>
            FromSizesAndBaselines(size, contentSize, new Point<float?>(null, null));

        public static LayoutOutput FromOuterSize(Size<float> size) =>
            FromSizes(size, SizeF.ZERO);
    }
