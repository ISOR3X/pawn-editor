...
public class SectionWorker_FavColor(SectionDef def) : SectionWorker(def)
{
    protected override void DoSectionContents(TaffyBuilder builder, Pawn pawn)
    {
        ...
        builder.Text("Favorite color",
            style: new StyleOverride { margin = new Rect<LengthPercentageAuto>(0, GenUI.GapLabel, 0, 0) });
        ...
        }, new StyleOverride { width = UIUtility.ButtonHeight, height = UIUtility.ButtonHeight });
    }
}