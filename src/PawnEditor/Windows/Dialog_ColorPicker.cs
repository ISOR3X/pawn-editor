...
public class Dialog_ColorPicker : Window
{
    ...
    public override void DoWindowContents(Rect inRect)
    {
        Void.Taffy.Div(inRect, builder =>
                        ...
                        contentBuilder.Div(leftBuilder =>
                            {
                                leftBuilder.Div(widgetBuilder =>
                                    ...
                                    new StyleOverride
                                    {
                                        width = Dimension.Px(200f), height = Dimension.Px(200f),
                                ...
                                leftBuilder.Div(hslBuilder =>
                                {
                                    ...
                                    hslBuilder.InputNumber(ref hInt, 0, 360, id: "color_h",
                                        style: new StyleOverride
                                            { minWidth = Dimension.Px(50f), width = Dimension.Auto() });
                                ...
                                }, new StyleOverride
                                {
                                    ...
                                    gridTemplateColumns =
                                        [TrackSizingFunction.Fr(), TrackSizingFunction.Fr(), TrackSizingFunction.Fr()],
                            ...
                            new StyleOverride
                            {
                                ...
                                gap = new TaffyAxes(Dimension.Px(0f), Dimension.Px(4f)), width = Dimension.Px(200f)
                            });
                        contentBuilder.Div(rightBuilder =>
                            {
                                rightBuilder.Div(paletteBuilder =>
                                        ...
                                        foreach (var c in _colors)
                                            paletteBuilder.Item(r =>
                                                ...
                                                new StyleOverride
                                                {
                                                    ...
                                                    height = Dimension.Px(GenUI.SmallIconSize)
                                                });
                                        paletteBuilder.Item(r =>
                                        {
                                            if (Verse.Widgets.ButtonInvisible(r))
                                                _selectedColor = GenColor.RandomColorOpaque();
                                            Verse.Widgets.DrawHighlightIfMouseover(r);
                                    ...
                                    new StyleOverride
                                    {
                                        ...
                                        alignContent = TaffyAlignContent.Start,
                                ...
                                rightBuilder.Div(colorReadoutBuilder =>
                                    ...
                                    new StyleOverride
                                    {
                                        height = Dimension.Px(Text.LineHeightOf(GameFont.Small)),
                                        gap = new TaffyAxes(Dimension.Px(GenUI.GapTiny), Dimension.Px(GenUI.GapTiny))
                                    });
                            },
                            new StyleOverride
                            {
                                flexDirection = TaffyFlexDirection.Column,
                                justifyContent = TaffyAlignContent.SpaceBetween
                            });
                    },
                    new StyleOverride
            ...
            {
                flexDirection = TaffyFlexDirection.Column,
                gap = new TaffyAxes(Dimension.Px(0f), Dimension.Px(GenUI.GapSmall))
            });
    }
