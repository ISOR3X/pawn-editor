...
/// </summary>
/// <summary>
///     Renamed from <c>Taffy</c>: the new immediate tree lives in the <c>Void.Taffy</c> namespace, and a
///     type cannot share a fully-qualified name with a namespace. Call sites use <c>Void.TaffyLegacy</c>.
/// </summary>
public static class TaffyLegacy
{
    #region ENTRY POINTS
