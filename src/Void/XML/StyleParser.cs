...
/// <summary>
///     Mostly generated by Claude Opus 5 - this is simple parsing done only on startup and relatively straightforward
///     code.
///     Perhaps in the future we can relay this to Taffy[cssparser] to reduce duplicate code.
/// </summary>
public static class StyleParser
{
    ...
    private static void ExpandRepeat(string token, List<TaffyTrackSizingFunction> result)
    {
        ...
        fallback:
        Log.Warning(
            $"[{VoidMod.ModName}] grid repeat() with non-integer count is not supported by ctaffy; substituting auto.");
